def rename_leagues(df):
    ...
    df.replace('Austrian Bundesliga','AUSTRIA - 2. LIGA', inplace=True)
    df.replace('Austrian Erste Liga','AUSTRIA - BUNDESLIGA', inplace=True)
    ...
    df.replace('UEFA Champions League','EUROPE - CHAMPIONS LEAGUE', inplace=True)
    df.replace('UEFA Europa Conference League','EUROPE - EUROPA CONFERENCE LEAG', inplace=True)
    df.replace('UEFA Europa League','EUROPE - EUROPA LEAGUE', inplace=True)
    ...
    df.replace('Paraguayan Primera Division','PARAGUAY - PRIMERA DIVISION', inplace=True)
    ...
    df.replace('US MLS','USA - MLS', inplace=True)
...
def rename_teams(df):
    ...
    df.replace("Always Ready","Always Ready", inplace=True)
    df.replace("Aurora","Aurora", inplace=True)
    df.replace("Blooming Santa Cruz","Blooming", inplace=True)
    df.replace("Bolivar","Bolivar", inplace=True)
    df.replace("CD Gualberto Villarroel","GV San Jose", inplace=True)
    df.replace("CI Petrolero","Independiente", inplace=True)
    df.replace("Club Ind Petrolero","Independiente", inplace=True)
    df.replace("Club Independiente","Independiente", inplace=True)
    df.replace("Club Independiente Petrolero","Independiente", inplace=True)
    df.replace("Club Petrolero","Independiente", inplace=True)
    df.replace("Club Real Santa Cruz","Santa Cruz", inplace=True)
    df.replace("Guabira","Guabira", inplace=True)
    df.replace("Inde Petrol","Independiente", inplace=True)
    df.replace("Jorge Wilstermann","Wilstermann", inplace=True)
    df.replace("Nacional Potosi","Nacional Potosi", inplace=True)
    df.replace("Oriente Petrolero","Oriente Petrolero", inplace=True)
    df.replace("Real Tomayapo","Tomayapo", inplace=True)
    df.replace("Royal Pari","Royal Pari", inplace=True)
    df.replace("San Antonio FC","SA Bulo Bulo", inplace=True)
    df.replace("The Strongest","The Strongest", inplace=True)
    df.replace("Universitario de Vinto","Universitario de Vinto", inplace=True)
    ...
    df.replace("Confianca","Confianca", inplace=True)
    df.replace("EC Sao Jose Porto Alegre","EC Sao Jose", inplace=True)
    df.replace("Ferroviaria","Ferroviaria", inplace=True)
    df.replace("Ferroviario","Ferroviario", inplace=True)
    df.replace("Figueirense","Figueirense", inplace=True)
    df.replace("Floresta EC","Floresta EC", inplace=True)
    ...
    df.replace("Sao Bernardo","EC Sao Jose", inplace=True)
    ...
    df.replace("Agua Santa","Agua Santa", inplace=True)
    df.replace("Aguia de Maraba","Aguia De Maraba", inplace=True)
    df.replace("Altos","AE Altos", inplace=True)
    df.replace("America RN","America RN", inplace=True)
    df.replace("Anapolis GO","Anapolis", inplace=True)
    df.replace("Asa AL","ASA", inplace=True)
    df.replace("Audax Rio","Audax RJ", inplace=True)
    df.replace("Barra FC","Barra FC", inplace=True)
    df.replace("Brasil de Pelotas","Brasil de Pelotas", inplace=True)
    df.replace("Brasiliense","Brasiliense", inplace=True)
    df.replace("CA Patrocinense","Patrocinense", inplace=True)
    df.replace("CRAC","CRAC", inplace=True)
    df.replace("Cameta","Cameta", inplace=True)
    ...
    df.replace("Concordia CA","Concordia", inplace=True)
    ...
    df.replace("Fluminense-PI","Fluminense-PI", inplace=True)
    df.replace("Hercilio Luz","Hercilio Luz", inplace=True)
    ...
    df.replace("Maranhao","Maranhao", inplace=True)
    df.replace("Maringa","Maringa", inplace=True)
    df.replace("Mixto","Mixto", inplace=True)
    df.replace("Moto Clube","Moto Club", inplace=True)
    df.replace("Nova Iguacu","Nova Iguacu", inplace=True)
    df.replace("Novo Hamburgo","Novo Hamburgo", inplace=True)
    df.replace("Petrolina PE","Petrolina", inplace=True)
    df.replace("Porto Velho EC","Porto Velho", inplace=True)
    df.replace("Portuguesa RJ","Portuguesa RJ", inplace=True)
    df.replace("Potiguar","Potiguar de Mossoro", inplace=True)
    df.replace("Pouso Alegre","Pouso Alegre", inplace=True)
    df.replace("Princesa Dos Solimoes","Princesa do Solimoes", inplace=True)
    df.replace("Real Brasilia","Real Brasilia", inplace=True)
    df.replace("Real Noroeste","Real Brasilia", inplace=True)
    ...
    df.replace("Santo Andre","Santo Andre", inplace=True)
    df.replace("Sao Jose EC SP","Sao Jose EC", inplace=True)
    df.replace("Sao Raimundo","Sao Raimundo RR", inplace=True)
    df.replace("Sergipe","Sergipe", inplace=True)
    df.replace("Serra","Serra", inplace=True)
    df.replace("Sousa EC","Sousa", inplace=True)
    df.replace("Tocantinopolis","Tocantinopolis", inplace=True)
    ...
    df.replace("Lokomotiv Plovdiv","Botev Plovdiv", inplace=True)
    df.replace("Lokomotiv Sofia","CSKA 1948 Sofia", inplace=True)
    df.replace("Ludogorets","Ludogorets", inplace=True)
    df.replace("PFC Levski Sofia","CSKA 1948 Sofia", inplace=True)
    df.replace("Pirin Blagoevgrad","Pirin Blagoevgrad", inplace=True)
    df.replace("Slavia Sofia","CSKA 1948 Sofia", inplace=True)
    ...
    df.replace("Nublense","Nublense", inplace=True)
    ...
    df.replace("Union La Calera","Union La Calera", inplace=True)
    df.replace("Univ Catolica (Chile)","U. Catolica", inplace=True)
    ...
    df.replace("Fortaleza FC","Fortaleza", inplace=True)
    df.replace("Ind Medellin","Ind. Medellin", inplace=True)
    df.replace("Jaguares de Cordoba","Jaguares de Cordoba", inplace=True)
    ...
    df.replace("Once Caldas","Once Caldas", inplace=True)
    df.replace("Santa Fe","Santa Fe", inplace=True)
    ...
    df.replace("FK Jablonec","FK Pardubice", inplace=True)
    ...
    df.replace("Sparta Prague","Slavia Prague", inplace=True)
    ...
    df.replace("Macara","Macara", inplace=True)
    df.replace("Mushuc Runa","Mushuc Runa", inplace=True)
    ...
    df.replace("Pharco FC","Future FC", inplace=True)
    ...
    df.replace("Atlantis","Atlantis", inplace=True)
    df.replace("EPS","EPS", inplace=True)
    ...
    df.replace("GOA Lyonnaise","GOAL FC", inplace=True)
    df.replace("GOAL","GOAL FC", inplace=True)
    df.replace("GOAL FC","GOAL FC", inplace=True)
    df.replace("Grand OA Lyon","GOAL FC", inplace=True)
    df.replace("Grand Ouest Association Lyonnaise","GOAL FC", inplace=True)
    df.replace("Le Mans","Le Mans", inplace=True)
    df.replace("Marignane-Gign","Marignane GCB", inplace=True)
    ...
    df.replace("Villefranche B","Villefranche", inplace=True)
    ...
    df.replace("Longford","Longford", inplace=True)
    ...
    df.replace("Sligo Rovers","Shamrock Rovers", inplace=True)
    df.replace("St Patricks","St. Patricks", inplace=True)
    df.replace("Waterford","Waterford", inplace=True)
    ...
    df.replace("Hapoel Jerusalem","Hapoel Jerusalem", inplace=True)
    df.replace("Hapoel Petach Tikva","Hapoel Petah Tikva", inplace=True)
    df.replace("Hapoel Petah Tikva","Hapoel Petah Tikva", inplace=True)
    ...
    df.replace("Maccabi Petah-Tikva","Maccabi Petah Tikva", inplace=True)
    ...
    df.replace("ACR Messina","ACR Messina", inplace=True)
    df.replace("AP Turris Calcio","Turris", inplace=True)
    ...
    df.replace("Alessandria","Alessandria", inplace=True)
    df.replace("Ancona","Ancona", inplace=True)
    ...
    df.replace("Entella","Entella", inplace=True)
    ...
    df.replace("Nuova Monterosi","Monterosi", inplace=True)
    df.replace("Olbia","Olbia", inplace=True)
    df.replace("Padova","Padova", inplace=True)
    ...
    df.replace("Potenza","Potenza", inplace=True)
    df.replace("Pro Vercelli","Pro Patria", inplace=True)
    ...
    df.replace("SS Virtus Verona 1921","Virtus Francavilla", inplace=True)
    df.replace("Sassari Torres","Torres", inplace=True)
    df.replace("Sorrento","Sorrento", inplace=True)
    df.replace("Spal","Spal", inplace=True)
    df.replace("Taranto Sport","Taranto", inplace=True)
    df.replace("Triestina","Triestina", inplace=True)
    df.replace("US Francavilla","Virtus Francavilla", inplace=True)
    df.replace("US Latina Calcio","Latina", inplace=True)
    df.replace("US Virtus Francavilla","Virtus Francavilla", inplace=True)
    df.replace("US Virtus Francavilla Calcio","Virtus Francavilla", inplace=True)
    df.replace("USD Sestri Levante 1919","Sestri Levante", inplace=True)
    df.replace("Virtus Francavilla","Virtus Francavilla", inplace=True)
    df.replace("Virtus Francavilla Calcio","Virtus Francavilla", inplace=True)
    df.replace("AC Bra","Bra", inplace=True)
    df.replace("AC Carpi","AC Carpi", inplace=True)
    df.replace("ASD Alcione","Alcione Milano", inplace=True)
    df.replace("ASD Atletico Ascoli","Atletico Ascoli", inplace=True)
    df.replace("ASD Calcio Brusaporto","Brusaporto", inplace=True)
    df.replace("ASD Calcio Caldiero Terme","Caldiero Terme", inplace=True)
    df.replace("ASD Cassino Calcio","Cassino", inplace=True)
    df.replace("ASD Citta di Gallipoli","Gallipoli", inplace=True)
    df.replace("ASD Gladiator 1924","Gladiator", inplace=True)
    df.replace("ASD Mobilieri Ponsacco","Mobilieri Ponsacco", inplace=True)
    df.replace("ASD Portici 1906","Portici 1906", inplace=True)
    df.replace("ASD Real Monterotondo","Real Monterotondo", inplace=True)
    df.replace("ASD San Donato Tavarnelle","San Donato", inplace=True)
    df.replace("ASD San Luca","San Luca", inplace=True)
    df.replace("ASD Sanremese","Sanremese", inplace=True)
    df.replace("ASD Tau Calcio Altopascio","Tau", inplace=True)
    df.replace("ASD Trastevere Calcio","Trastevere Calcio", inplace=True)
    df.replace("ASD Vogherese 1919","Vogherese", inplace=True)
    df.replace("Akragas","Akragas", inplace=True)
    df.replace("Alma Juventus Fano","Fano", inplace=True)
    df.replace("Anzio Calcio","Anzio Calcio 1924", inplace=True)
    df.replace("Ardea NF Calcio","Tivoli Calcio", inplace=True)
    df.replace("Barletta","Barletta", inplace=True)
    df.replace("Budoni Calcio","Budoni", inplace=True)
    df.replace("Calcio Chieri 1955","Chieri", inplace=True)
    df.replace("Campobasso","Campobasso", inplace=True)
    df.replace("Campodarsego","Campodarsego", inplace=True)
    df.replace("Chieti","Calcio Chieti", inplace=True)
    df.replace("Citta di Sant Agata","S. Agata", inplace=True)
    df.replace("Citta di Varese","Citta di Varese", inplace=True)
    df.replace("Este","Este", inplace=True)
    df.replace("FC Matese","Matese", inplace=True)
    df.replace("FC Pro Palazzolo","Pro Palazzolo", inplace=True)
    df.replace("Fidelis Andria","Fidelis Andria", inplace=True)
    df.replace("Figline","Figline", inplace=True)
    df.replace("Follonica Gavorrano","Follonica Gavorrano", inplace=True)
    df.replace("Ghivizzano Borgo A Mozzano","Ghivizzano Borgo", inplace=True)
    df.replace("Grosseto","Grosseto", inplace=True)
    df.replace("Ligorna","Ligorna", inplace=True)
    df.replace("Matera","Matera", inplace=True)
    df.replace("Mezzolara","Mezzolara", inplace=True)
    df.replace("Orvietana Calcio","Orvietana", inplace=True)
    df.replace("Paganese","Paganese", inplace=True)
    df.replace("Real Calepina FC","Real Calepina", inplace=True)
    df.replace("Reggio Calabria","Reggio Calabria", inplace=True)
    df.replace("Roma City FC","Roma City", inplace=True)
    df.replace("Rotonda Calcio","Rotonda", inplace=True)
    df.replace("S.S.D. Casarano Calcio","Casarano", inplace=True)
    df.replace("SC Cenaia 1969","SC Cenaia", inplace=True)
    df.replace("SSD Chieti FC 1922","Calcio Chieti", inplace=True)
    df.replace("Sambenedettese","Sambenedettese", inplace=True)
    df.replace("San Nicolo Notaresco","S. N. Notaresco", inplace=True)
    df.replace("Sporting Trestina","Trestina", inplace=True)
    df.replace("Team Altamura","Altamura", inplace=True)
    df.replace("Termoli","Termoli", inplace=True)
    df.replace("Tivoli Calcio","Tivoli Calcio", inplace=True)
    df.replace("Trapani","Trapani", inplace=True)
    df.replace("US Livorno 1915 SSD","Livorno", inplace=True)
    df.replace("US Pianese","Pianese", inplace=True)
    df.replace("USD Caravaggio","Caravaggio", inplace=True)
    df.replace("USD Citta di Fasano","Citta di Fasano", inplace=True)
    df.replace("USD Lavagnese 1919","Lavagnese", inplace=True)
    df.replace("USD Palmese 1914","Palmese 1914", inplace=True)
    df.replace("Union Clodiense Chioggia","Union Clodiense", inplace=True)
    df.replace("United Riccione","United Riccione", inplace=True)
    df.replace("Vastogirardi","Vastogirardi", inplace=True)
    df.replace("Vibonese","Vibonese", inplace=True)
    df.replace("Virtus Bolzano","Virtus Bolzano", inplace=True)
    df.replace("Virtus Ciserano Bergamo","Ciserano-Bergamo", inplace=True)
    ...
    df.replace("Kagoshima Utd","Kagoshima Utd", inplace=True)
    ...
    df.replace("Yokohama FC","Fujieda MYFC", inplace=True)
    ...
    df.replace("Jong PSV Eindhoven","Eindhoven FC", inplace=True)
    ...
    df.replace("Annagh United","Annagh", inplace=True)
    df.replace("Ards","Ards", inplace=True)
    df.replace("Ards FC","Ards", inplace=True)
    df.replace("Ballyclare Comrades","Ballyclare", inplace=True)
    df.replace("Bangor","Bangor FC", inplace=True)
    df.replace("Dergview","Dergview", inplace=True)
    df.replace("H & W Welders","H&W Welders", inplace=True)
    df.replace("HW Welders FC","H&W Welders", inplace=True)
    df.replace("Institute","Institute", inplace=True)
    df.replace("Knockbreda","Knockbreda", inplace=True)
    df.replace("Newington","Newington", inplace=True)
    df.replace("Portadown","Portadown", inplace=True)
    df.replace("Ballymena","Ballymena", inplace=True)
    ...
    df.replace("Dungannon","Dungannon", inplace=True)
    ...
    df.replace("Newry","Newry City", inplace=True)
    ...
    df.replace("Club General Caballero JL","General Caballero JLM", inplace=True)
    ...
    df.replace("Sol de America","Sol de America", inplace=True)
    df.replace("Sportivo Luqueno","Sp. Luqueno", inplace=True)
    df.replace("Sportivo Trinidense","Sportivo Trinidense", inplace=True)
    ...
    df.replace("Asociacion Deportiva Tarma","ADT Tarma", inplace=True)
    df.replace("Atletico Grau","Grau", inplace=True)
    df.replace("CD Los Chankas","Los Chankas", inplace=True)
    df.replace("Carlos Mannucci","Carlos Mannucci", inplace=True)
    df.replace("Cienciano","Cienciano", inplace=True)
    df.replace("Comerciantes Unidos","Comerciantes Unidos", inplace=True)
    df.replace("Cusco FC","Cusco", inplace=True)
    df.replace("Deportivo Garcilaso","Deportivo Garcilaso", inplace=True)
    df.replace("Melgar","FBC Melgar", inplace=True)
    df.replace("Sport Boys (Per)","Sport Boys", inplace=True)
    df.replace("Sport Huancayo","Sport Huancayo", inplace=True)
    df.replace("Sporting Cristal","Sporting Cristal", inplace=True)
    df.replace("UTC Cajamarca","Cajamarca", inplace=True)
    df.replace("Union Comercio","Union Comercio", inplace=True)
    df.replace("Universidad Cesar Val","Cesar Vallejo", inplace=True)
    df.replace("Universidad Cesar Vallejo","Cesar Vallejo", inplace=True)
    df.replace("Universitario de Depo","U. de Deportes", inplace=True)
    df.replace("Universitario de Depor","U. de Deportes", inplace=True)
    df.replace("Universitario de Deportes","U. de Deportes", inplace=True)
    df.replace("Arka Gdynia","Arka Gdynia", inplace=True)
    df.replace("Chrobry Glogow","Chrobry Glogow", inplace=True)
    ...
    df.replace("Lechia Gdansk","Lechia Gdansk", inplace=True)
    ...
    df.replace("Wisla Plock","Wisla Plock", inplace=True)
    df.replace("Zaglebie Sosnowiec","Zaglebie Sosnowiec", inplace=True)
    ...
    df.replace("FC U Craiova 1948","FC Botosani", inplace=True)
    ...
    df.replace("Poli Iasi","Poli Iasi", inplace=True)
    df.replace("Rapid Bucharest","FC Rapid Bucuresti", inplace=True)
    df.replace("UTA Arad","UTA Arad", inplace=True)
    df.replace("Universitatea Cluj","CFR Cluj", inplace=True)
    df.replace("Universitatea Craiova","U Craiova 1948", inplace=True)
    ...
    df.replace("CSM Slatina","CSM Slatina", inplace=True)
    df.replace("Ceahlaul","Ceahlaul", inplace=True)
    df.replace("Chindia Targoviste","Chindia Targoviste", inplace=True)
    ...
    df.replace("FC Unirea Dej","Unirea Dej", inplace=True)
    df.replace("FCM Alexandria","Alexandria", inplace=True)
    df.replace("Gloria Buzau","Gloria Buzau", inplace=True)
    df.replace("Unirea Slobozia","Unirea Dej", inplace=True)
    ...
    df.replace("FK Graficar","Graficar Beograd", inplace=True)
    ...
    df.replace("Metalac Gornji Milanovac","Metalac", inplace=True)
    df.replace("OFK Beograd","OFK Beograd", inplace=True)
    df.replace("RFK Novi Sad","RFK Novi Sad", inplace=True)
    df.replace("Radnicki Novi Beograd","Graficar Beograd", inplace=True)
    df.replace("Tekstilac Odzaci","Tekstilac Odzaci", inplace=True)
    ...
    df.replace("FK Novi Pazar","IMT Novi Beograd", inplace=True)
    ...
    df.replace("Ajax Cape Town","Cape Town Spurs", inplace=True)
    df.replace("AmaZulu","AmaZulu", inplace=True)
    df.replace("Amazulu","AmaZulu", inplace=True)
    df.replace("Cape Town CIty F.C.","Cape Town City", inplace=True)
    df.replace("Chippa Utd","Chippa Utd.", inplace=True)
    ...
    df.replace("Moroka Swallows","Swallows", inplace=True)
    ...
    df.replace("Supersport Utd","Supersport Utd", inplace=True)
    ...
    df.replace("Villarreal B","Burgos CF", inplace=True)
    df.replace("Zaragoza","Zaragoza", inplace=True)
    df.replace("AD Llerenense","Llerenense", inplace=True)
    df.replace("AD San Juan","AD San Juan", inplace=True)
    df.replace("AD Union Adarve","Llerenense", inplace=True)
    df.replace("Aguilas","Aguilas FC", inplace=True)
    df.replace("Arandina CF","Arandina", inplace=True)
    df.replace("Arenas Club de Getxo","Arenas Club", inplace=True)
    df.replace("Athletic Bilbao B","Ath Bilbao B", inplace=True)
    df.replace("Barakaldo","Barakaldo", inplace=True)
    df.replace("Betis B","Betis B", inplace=True)
    df.replace("CA Antoniano","Antoniano", inplace=True)
    df.replace("CD Alaves B","Alaves B", inplace=True)
    df.replace("CD Atletico Paso","Atl. Paso", inplace=True)
    df.replace("CD Badajoz","CD Badajoz", inplace=True)
    df.replace("CD Brea","Brea", inplace=True)
    df.replace("CD Calahorra","Calahorra", inplace=True)
    df.replace("CD Cayon","Cayon", inplace=True)
    df.replace("CD Covadonga","Covadonga", inplace=True)
    df.replace("CD Estepona","CD Estepona", inplace=True)
    df.replace("CD Illescas","Illescas", inplace=True)
    df.replace("CD Izarra","Izarra", inplace=True)
    df.replace("CD Mensajero","Mensajero", inplace=True)
    df.replace("CDA Navalcarnero","Navalcarnero", inplace=True)
    df.replace("CDE Ursaria","Ursaria", inplace=True)
    df.replace("CE Andratx","Andratx", inplace=True)
    df.replace("CE Europa","CE Europa", inplace=True)
    df.replace("CF Badalona Futur","Badalona Futur", inplace=True)
    df.replace("Cacereno","Cacereno", inplace=True)
    df.replace("Cadiz B","Cadiz CF B", inplace=True)
    df.replace("Centre d'Esports Manresa","Manresa", inplace=True)
    df.replace("Cerdanyola del Valles","Cerdanyola", inplace=True)
    df.replace("Club Atletico Saguntino","Saguntino", inplace=True)
    df.replace("Coruxo","Coruxo FC", inplace=True)
    df.replace("El Palo","El Palo", inplace=True)
    df.replace("Espanyol B","Espanyol B", inplace=True)
    df.replace("FC Cartagena II","FC Cartagena SAD B", inplace=True)
    df.replace("FC La Union Atletico","La Union", inplace=True)
    df.replace("Getafe B","Getafe B", inplace=True)
    df.replace("Gimnastica Segoviana CF","Gimnastica Segoviana", inplace=True)
    df.replace("Guadalajara","Guadalajara", inplace=True)
    df.replace("Guijuelo","Guijuelo", inplace=True)
    df.replace("Hercules","Hercules", inplace=True)
    df.replace("La Nucia","La Nucia", inplace=True)
    df.replace("Linense","Linense", inplace=True)
    df.replace("Lleida","Lleida", inplace=True)
    df.replace("Manchego Ciudad Real","Ciudad Real", inplace=True)
    df.replace("Mar Menor CF","Racing Cartagena MM", inplace=True)
    df.replace("Marbella","Marbella", inplace=True)
    df.replace("Marino Luanco","Marino de Luanco", inplace=True)
    df.replace("Naxara CD","Naxara", inplace=True)
    df.replace("Numancia","Numancia", inplace=True)
    df.replace("Orihuela CF","Orihuela", inplace=True)
    df.replace("Pontevedra CF","Pontevedra", inplace=True)
    df.replace("RC Villalbes","Racing Club Villalbes", inplace=True)
    df.replace("RS Gimnastica","Torrelavega", inplace=True)
    df.replace("Real Aviles","Real Aviles", inplace=True)
    df.replace("Real Oviedo II","R. Oviedo B", inplace=True)
    df.replace("Real Sociedad III","Real Sociedad C", inplace=True)
    df.replace("Real Zaragoza II","Zaragoza B", inplace=True)
    df.replace("SD Compostela","Compostela", inplace=True)
    df.replace("SD Formentera","Formentera", inplace=True)
    df.replace("SD Gernika Club","Gernika", inplace=True)
    df.replace("SD Rayo Cantabria","Rayo Cantabria", inplace=True)
    df.replace("SE Penya Independent","Penya Indep.", inplace=True)
    df.replace("SS Reyes","San Sebastian Reyes", inplace=True)
    df.replace("San Roque Lepe","San Roque", inplace=True)
    df.replace("Santa Eulalia","Pena Deportiva", inplace=True)
    df.replace("Sevilla B","Sevilla FC B", inplace=True)
    df.replace("Talavera CF","CF Talavera", inplace=True)
    df.replace("Terrassa","Terrassa", inplace=True)
    df.replace("Torrent CF","Torrent", inplace=True)
    df.replace("Tudelano","Tudelano", inplace=True)
    df.replace("UCAM Murcia","UCAM Murcia", inplace=True)
    df.replace("UD Alzira","Alzira", inplace=True)
    df.replace("UD Barbastro","Barbastro", inplace=True)
    df.replace("UD Logrones","UD Logrones", inplace=True)
    df.replace("UD Montijo","Montijo", inplace=True)
    df.replace("UD Mutilvera","Mutilvera", inplace=True)
    df.replace("UD Ourense","Ourense CF", inplace=True)
    df.replace("UD San Fernando","San Fernando", inplace=True)
    ...
    df.replace("Valencia-Mestalla","Valencia B", inplace=True)
    df.replace("Valladolid B","Valladolid Promesas", inplace=True)
    df.replace("Valle de Egues","Valle Egues", inplace=True)
    df.replace("Velez CF","Velez", inplace=True)
    df.replace("Villanovense","Villanovense", inplace=True)
    ...
    df.replace("Bodrum BB","Bodrumspor", inplace=True)
    df.replace("Bodrum Bel","Bodrumspor", inplace=True)
    df.replace("Bodrum Bele","Bodrumspor", inplace=True)
    df.replace("Bodrum Belediyesi","Bodrumspor", inplace=True)
    df.replace("Bodrum Belediyesi Bodrumspor","Bodrumspor", inplace=True)
    df.replace("Bodrum Bodrumspor","Bodrumspor", inplace=True)
    df.replace("Bodrumspor","Bodrumspor", inplace=True)
    ...
    df.replace("Sanliurfa","Sanliurfaspor", inplace=True)
    ...
    df.replace("Danubio","Danubio", inplace=True)
    ...
    df.replace("Progreso","Progreso", inplace=True)
    df.replace("Racing Club (Uru)","Racing Montevideo", inplace=True)
    df.replace("Rampla Juniors","Rampla Juniors", inplace=True)
    df.replace("River Plate (Uru)","River Plate", inplace=True)
    ...
    df.replace("Metropolitanos","Metropolitanos", inplace=True)
    df.replace("Monagas","Monagas", inplace=True)
    df.replace("Portuguesa FC","Portuguesa", inplace=True)
    df.replace("Puerto Cabello","Puerto Cabello", inplace=True)
    df.replace("Rayo Zuliano","Rayo Zuliano", inplace=True)
